...
require_once(ROOT_PATH . '/action/NavigationAction.class.php');
require_once(ROOT_PATH . '/model/Model.class.php');
require_once(ROOT_PATH . '/model/NavigationModel.class.php');
require_once(ROOT_PATH . '/include/Page.class.php');

$template = new Template();
$navigation = new NavigationAction($template);
//注入变量应在生成编译文件之前注入
$template->display('navigation.tpl');
